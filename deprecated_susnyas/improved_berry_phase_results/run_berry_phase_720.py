...
if __name__ == "__main__":
    # Run the calculation with theta values from 0 to 720 degrees
    results_720 = run_berry_phase_calculation(
        theta_max_degrees=720,
        num_points=2000,  # Double the points for smoother curves
        output_suffix="_720"
    )
    
    print("\nCalculation completed for theta values from 0 to 720 degrees.")
    print(f"Results saved to: {results_720['output_dir']}")
