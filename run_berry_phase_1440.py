...
if __name__ == "__main__":
    # Run the calculation with theta values from 0 to 1440 degrees
    results_1440 = run_berry_phase_calculation(
        theta_max_degrees=1440,
        num_points=2000,  # Double the points for smoother curves
        output_suffix="_1440"
    )
    
    print("\nCalculation completed for theta values from 0 to 1440 degrees.")
    print(f"Results saved to: {results_1440['output_dir']}")
