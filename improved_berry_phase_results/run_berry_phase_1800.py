...
if __name__ == "__main__":
    # Run the calculation with theta values from 0 to 1800 degrees
    results_1800 = run_berry_phase_calculation(
        theta_max_degrees=1800,
        num_points=2000,  # Double the points for smoother curves
        output_suffix="_1800"
    )
    
    print("\nCalculation completed for theta values from 0 to 1800 degrees.")
    print(f"Results saved to: {results_1800['output_dir']}")
